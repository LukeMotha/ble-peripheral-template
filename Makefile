...
# NOTE: Since SDK is a build input in the nix derivation SDK_ROOT is set
# during the build phase when it's path is known hence it's absence here
PROJ_DIR := .
...
# Flash the program
flash: result/bin/nrf52840_xxaa.hex
	@echo Flashing: result/bin/nrf52840_xxaa.hex
	nrfjprog -f nrf52 --program result/bin/nrf52840_xxaa.hex --sectorerase
...
# TODO: Package CMSIS config tool?
